      ...
      <div className="flex-grow">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="mt-6 text-lg md:text-xl text-gray-600 leading-relaxed">
            SyncDoc is an AI Self Learning platform that transforms the way you interact with information.
            Powered by intelligent agents and advanced document understanding, SyncDoc enables
        ...
        <div className="max-w-6xl mx-auto mt-16 grid md:grid-cols-2 gap-10">
          <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
            <h2 className="text-2xl font-semibold text-blue-600 mb-4">What is SyncDoc?</h2>
            <p className="text-gray-700 leading-relaxed">
              SyncDoc is more than just a tool—it's an evolving digital partner. Users can upload documents,
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
            <h2 className="text-2xl font-semibold text-purple-600 mb-4">Why SyncDoc?</h2>
            <p className="text-gray-700 leading-relaxed">
              We believe documents shouldn’t be static. With SyncDoc Agents, information becomes interactive.
              Whether you're analyzing data, summarizing reports, or coordinating workflows—SyncDoc
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm md:col-span-2">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              intelligent AI agents. SyncDoc aims to create a self-learning environment where machines not only assist
